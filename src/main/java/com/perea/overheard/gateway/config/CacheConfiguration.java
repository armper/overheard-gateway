package com.perea.overheard.gateway.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.perea.overheard.gateway.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.perea.overheard.gateway.repository.UserRepository.USERS_BY_EMAIL_CACHE);
