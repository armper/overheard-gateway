...
```
$ docker image tag overheardgateway gcr.io/the-overheard-club/overheardgateway
$ gcloud docker -- push gcr.io/the-overheard-club/overheardgateway
```
...
```
$ kubectl get svc overheardgateway
```
